...
\end{equation}
Detailed discussion on the Fermi functions is delegated to the Appendix A.
...
{\bf Discussion.} Estimate the effect of the Fermi statistics on the ionization degree.
