...
Debye-Huekel correlation energy as well as the Madelung energy) as well as the 
\begin{center}
...
However, the calculation still requires a two-layer iterative approach (iterations 
within each iteration), with around 3-6 iterations for each step, which still requires 
a relatively significant computing time.
