...
written as:
\begin{equation}
P_{i}=\frac{p_{i}}{\sum p_{i}},\ {\rm where}\ \ \ \ \ \ \ \ \ \ p_{i}=\left(C_{0}\frac{(T_{eV})^{\frac{3}{2}}}{Z}\right)^{i}e^{-\frac{E_{i}}{T_{eV}}},\label{eq:30}
\end{equation}
...
we have:
\begin{eqnarray}
p_{i}^{\prime}=\left(C_{0}\frac{(T_{eV})^{\frac{3}{2}}}{Z}\right)^{i}e^{-\frac{E_{i}}{T_{eV}}}\left(\frac{E_{i}}{(T_{eV})^{2}}\right)+\left(C_{0}^{\ \ i}\right)i\left(\frac{(T_{eV})^{\frac{3}{2}}}{Z}\right)^{i-1}\left(\frac{\frac{3}{2}(T_{eV})^{\frac{1}{2}}}{Z}-\frac{(T_{eV})^{\frac{3}{2}}}{Z^{2}} Z^\prime \right)e^{-\frac{E_{i}}{T_{eV}}}=\nonumber\\
=p_{i}\left(\frac{E_{i}}{(T_{eV})^{2}}+i\frac{Z}{(T_{eV})^{\frac{3}{2}}}\left(\frac{\frac{3}{2}(T_{eV})^{\frac{1}{2}}}{Z}-\frac{(T_{eV})^{\frac{3}{2}}}{Z^{2}} Z^\prime \right)\right)=p_{i}\left(\frac{E_{i}}{(T_{eV})^{2}}+i\left(\frac{3}{2T_{eV}}-\frac{ Z^\prime }{Z}\right)\right)\label{eq:32}
\end{eqnarray}
Also, since
\begin{equation}
Z=\frac{\sum ip_{i}}{\sum p_{i}},\ {\rm it\,follows\,that}\ \ \ \ \ \ \ 
...
$a$ and $b$:
\begin{equation}
<ab>-<a><b>=<\delta a\ \delta b>,\ {\rm where}\ \ \ \ \delta a=a-<a>\label{eq:36}\end{equation}
 \[
{\rm proof:}\ \ \ <(a-<a>)\ (b-<b>)>=<ab-a<b>-b<a>+<a><b>>=\]
 \[
=<ab>-2<a><b>+<a><b>=<ab>-<a><b>\]
...
=\frac{p_{i}}{(T_{eV})^{2}}\left(E_{i}+i\ \frac{\frac{3}{2}T_{eV}Z-<\delta i\ \delta E_{i}>}{Z+<(\delta i)^{2}>}\right),\ {\rm and\, let\, this\,}=\alpha p_{i}\label{eq:37}
\end{eqnarray}
...
=\frac{P_{i}}{(T_{eV})^{2}}\left(\delta E_{i}+\delta i\left(\frac{\frac{3}{2}T_{eV}Z-<\delta i\ \delta E_{i}>}{Z+<(\delta i)^{2}>}\right)\right),\ {\rm and\, let\, this\,}=\frac{P_{i}}{(T_{eV})^{2}}\left(\delta E_{i}+\beta\delta i\right).\label{eq:38}
\end{eqnarray}
...
\begin{equation}
T_{n+1}=T_{n}-\frac{U(T_{n})-U_{given}}{C_{V}(T_{n})},\ {\rm where}\ \ U=\frac{3}{2}k_{B}T(1+Z)+<E_{i}>{\rm and}\label{eq:CalcT}
\end{equation}
\[
...
\begin{equation}
C_{j}=\frac{N_{j}}{N_{a}}=\frac{{\displaystyle \sum_{i=0}^{X}N_{ij}}}{N_{a}}{\rm,\, and\,hence\,also\,}\sum_{j=1}^{n}C_{j}=1\label{eq:Cj}.
\end{equation}
...
\begin{equation}
Z=\sum_{j=1}^{n}\left[C_{j}\frac{{\displaystyle \sum}ip_{ij}}{{\displaystyle \sum}p_{ij}}\right]{\rm,\, where\, as\, before\, }p_{ij}=\left(\frac{C_{1}}{Z}\right)^{i}e^{-\frac{E_{ij}}{k_{B}T_{e}}}\label{eq:41}
\end{equation}
...
\end{equation}
Here, once again, for any expression $a,\ <a>_{j}={\displaystyle \sum_{i=0}^{X}aP_{ij}{\rm,\, and\, }\delta a=a-<a>}$.
