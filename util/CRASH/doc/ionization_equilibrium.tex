...
\title{{\Large Calculating Ion Populations in an Ideal Plasma}}

\maketitle

\part{{\LARGE Calculating Populations from Known Temperature}}
...
\begin{center}
\input{TextTable1.tex} 
\par\end{center}


\part{{\LARGE Calculating Temperature from the Internal Energy}}
