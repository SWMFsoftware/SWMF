...
statistical average of these values across all elements. Also, note that from here on, for any expression $a, \ll a\gg =\sum_{j}[C_{j}\sum_{i}(P_{i}a_{ij})]$, which is the statistical average first, across the populations and then, across the elements. 
\begin{equation}
