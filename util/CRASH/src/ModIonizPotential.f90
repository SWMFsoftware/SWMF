...
module ModIonizPotential
 ...
 real, parameter, dimension(30,21:30) :: cPotentials30_II = reshape((/&
  ...
  1804.  , 1919.   , 2060. , 2182. , 2310., 2478. , 2560. , 11050., 11400., 0. ,& ! 20-s  <==19 was  APPROXIMATED

  9.39405, 17.96440, 39.723, 59.4  , 82.6 , 108.  , 136.  , 175.  , 203. , 238. ,& ! 30 - Zn
  274.   , 311.    , 412.  , 454.  , 490. , 542.  , 579.  , 619.  , 698. , 738. ,& ! 10-s
  1856.  , 1970.   , 2088. , 2234. , 2363., 2495. , 2660. , 2730. , 11200., 12200./),& ! 20-s  <== 19,20 was APPROXIMATED
  (/30,10/))

!public :: get_ionization_potential30

contains
  subroutine get_ioniz_potential30( nZ, cPotential_I)
         ...
         select case (nZ)
           ...
           case default
             print*, "No such element found in the database"
         end select

  end subroutine get_ioniz_potential30  
