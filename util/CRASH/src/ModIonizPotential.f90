...
real, parameter, dimension(10,10) :: cPotentials10_II = reshape(  (/   &
 ...
 real, parameter, dimension(20,11:20) :: cPotentials20_II = reshape((/&
  ...
  265.1  , 292.    , 788.  , 863.  , 941. , 1044. , 1131. , 1221. , 1346., 1425.,& ! 10
  6249.  , 6626.   , 0.    , 0.    , 0.   , 0.    , 0.    , 0.    , 0.   , 0.   ,& ! 20s
  6.7463 , 14.66   , 29.311, 46.71 , 65.28, 128.1 , 150.6 , 173.4 , 205.8, 230.5,& !    23 - V
  255.1  , 308.    , 336.  , 896.  , 975. , 1060. , 1168. , 1260. , 1355., 1486.,& ! 10
  1569.  , 6851.   , 7246. , 0.    , 0.   , 0.    , 0.    , 0.    , 0.   , 0.   ,& ! 20
  ...
  1804.  , 1919.   , 2060. , 2182. , 2310., 2478. , 2560. , 11050., 11567.617, 0. ,&! 20-s <==29 is APPR (HandBook of...
  9.39405, 17.96440, 39.723, 59.4  , 82.6 , 108.  , 136.  , 175.  , 203. , 238. ,& ! 30 - Zn
  274.   , 311.    , 412.  , 454.  , 490. , 542.  , 579.  , 619.  , 698. , 738. ,& ! 10-s
  1856.  , 1970.   , 2088. , 2234. , 2363., 2495. , 2660. , 2730. , 11200., 12200./), (/30,10/))! 20-s <== 29,30 is APPR
