...
C----------------------------------------------------------------------C
		...
		DIMENSION X(-1:MX+2)
	    DIMENSION R(-1:MX+2),U(-1:MX+2),P(-1:MX+2),Z(-1:MX+2),G(-1:MX+2)
        DIMENSION IND(MX)
...
C----------------------------------------------------------------------C
	...
	SUBROUTINE ROE1D(N,R,U,P,Z,G,DTDX,IND)
		...
		DIMENSION CN(4,-1:MX+2),DWNP(5,4,-1:MX+2),NC(4,-1:MX+2),BLIM(4,-1:MX+2)
	    DIMENSION W(5,-1:MX+2)
		DIMENSION R(-1:MX+2),U(-1:MX+2),H(-1:MX+2),P(-1:MX+2),Z(-1:MX+2),G(-1:MX+2)
        DIMENSION IND(MX)
