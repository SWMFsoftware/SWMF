...
#define _O_BACKGROUND_SPEC_    0
#define _CO2_BACKGROUND_SPEC_  1
...
inline double GetCollisionCrossSectionBackgoundAtmosphereParticle(int spec,int BackgroundSpecieNumber,PIC::ParticleBuffer::byte *modelParticleData,PIC::ParticleBuffer::byte *BackgroundAtmosphereParticleData,double TranslationalEnergy,double cr2) {
...
inline double GetSigmaCrMax(int spec,int BackgroundSpecieNumber,PIC::ParticleBuffer::byte *modelParticleData) {
#if _BACKGROUND_ATMOSPHERE_COLLISION_CROSS_SECTION_ == _BACKGROUND_ATMOSPHERE_COLLISION_CROSS_SECTION__HARD_SPHERE_
...
inline double UserDefinedVelocityScatteringAngle(double* Vrel,double TranslationalEnergy,int spec,int BackgroundSpecieNumber) {
  return ForwardCollisionCrossSection.GetRandomScatteringAngle(TranslationalEnergy);
}


inline double GetBackgroundMolecularMass(int BackgroundSpecieNumber) {
  static const double BackgroundSpecieMass[2]={26.56E-27,73.05E-27};
  return BackgroundSpecieMass[BackgroundSpecieNumber];
}

inline void GenerateBackgoundAtmosphereParticle(PIC::ParticleBuffer::byte *BackgroundAtmosphereParticleData,int BackgroundSpecieNumber,PIC::Mesh::cDataCenterNode *cell,cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node) {
  int idim;
...
inline double GetBackgroundNumberDensity(int BackgroundSpecieNumber,double *x) {
  double res;
...
inline double GetCellMeanBackgroundNumberDensity(int BackgroundSpecieNumber,PIC::Mesh::cDataCenterNode *cell,cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node) {
  double x[3];
  cell->GetX(x);
...
inline double GetCellMaximumBackgroundNumberDensity(int BackgroundSpecieNumber,PIC::Mesh::cDataCenterNode *cell,cTreeNodeAMR<PIC::Mesh::cDataBlockAMR> *node) {
...
inline int GetTotalNumberBackgroundSpecies() {
  return 2;
}
