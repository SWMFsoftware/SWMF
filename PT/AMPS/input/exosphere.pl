...
while ($line=<InputFile>) {
  ...
  if ($InputLine eq "PHOTOLYTICREACTIONS") {
    ...
    if ($InputLine eq "ON") {
      RedefineMacro("_EXOSPHERE__ORBIT_CALCUALTION__MODE_","_PIC_MODE_ON_","models/exosphere/Exosphere.h");
    }
    elsif ($InputLine eq "OFF") {
      RedefineMacro("_EXOSPHERE__ORBIT_CALCUALTION__MODE_","_PIC_MODE_OFF_","models/exosphere/Exosphere.h");
...
printf "SPICE IS OFF!!!!!!!!!!!!!!!!!!\n";
    ...
    ChangeValueOfArray("static const double Exosphere_swVelocity_Typical\\[\\]",\@v,"models/exosphere/Exosphere.h");
    ChangeValueOfArray("static const double Exosphere_swB_Typical\\[\\]",\@B,"models/exosphere/Exosphere.h");
    ChangeValueOfVariable("static const double Exosphere_swTemperature_Typical",$T,"models/exosphere/Exosphere.h");
    ChangeValueOfVariable("static const double Exosphere_swNumberDensity_Typical",$n,"models/exosphere/Exosphere.h");
    ...
    if ($s0 eq "CONSTANT") {
      ...
      ChangeValueOfArray("static const double AccomodationCoefficient\\[\\]",\@InputValue,"models/exosphere/Exosphere.h"); 
    }
    else {
    ...
    ChangeValueOfVariable("static const char SimulationStartTimeString\\[\\]","\"$s1\"","models/exosphere/Exosphere.h");
  }
    ...
    while (defined $s1) {
      ($s0,$s1)=split(' ',$s1,2);
      AddLine2File("#include \"$s0\"","main/UserDefinition.PIC.PhysicalModelHeaderList.h");
    }    
  }
    ...
    if ($InputLine eq "FUNCTION") {
      ...
      AddLine2File($OutputLine,"main/UserDefinition.Exosphere.h");
    }
    else {
      die "Cannot recognize the option, line=$InputFileLineNumber ($InputFileName)\n";
    }
    ...
    if ($InputLine eq "PHOTONSTIMULATEDDESORPTION") {
      ...
      #add the parameters to the source code
      RedefineMacro("_EXOSPHERE_SOURCE__PHOTON_STIMULATED_DESPRPTION_","_EXOSPHERE_SOURCE__ON_","models/exosphere/Exosphere.h");
      ChangeValueOfVariable("static const double PhotonStimulatedDesorption_PhotonFlux_1AU",$PhotonFlux_1AU,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double PhotonStimulatedDesorption_CrossSection\\[\\]",\@CrossSection,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double PhotonStimulatedDesorption_minInjectionEnergy\\[\\]",\@minInjectionEnergy,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double PhotonStimulatedDesorption_maxInjectionEnergy\\[\\]",\@maxInjectionEnergy,"models/exosphere/Exosphere.h");
      
      RedefineMacro("_EXOSPHERE_SOURCE__ID__PHOTON_STIMULATED_DESPRPTION_",$SourceProcessID,"models/exosphere/Exosphere.h");
      ...
      #add the parameters to the source code
      RedefineMacro("_EXOSPHERE_SOURCE__THERMAL_DESORPTION_","_EXOSPHERE_SOURCE__ON_","models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double ThermalDesorption_uThermal\\[\\]",\@uThermal,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double ThermalDesorption_VibrationalFrequency\\[\\]",\@VibrationalFrequency,"models/exosphere/Exosphere.h");
      
      RedefineMacro("_EXOSPHERE_SOURCE__ID__THERMAL_DESORPTION_",$SourceProcessID,"models/exosphere/Exosphere.h");     
      ...
      #add the parameters to the source code
      RedefineMacro("_EXOSPHERE_SOURCE__SOLAR_WIND_SPUTTERING_","_EXOSPHERE_SOURCE__ON_","models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double SolarWindSputtering_Yield\\[\\]",\@Yield,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double SolarWindSputtering_minInjectionEnergy\\[\\]",\@minInjectionEnergy,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double SolarWindSputtering_maxInjectionEnergy\\[\\]",\@maxInjectionEnergy,"models/exosphere/Exosphere.h");
      
      RedefineMacro("_EXOSPHERE_SOURCE__ID__SOLAR_WIND_SPUTTERING_",$SourceProcessID,"models/exosphere/Exosphere.h");
      ...
      RedefineMacro("_EXOSPHERE_SOURCE__IMPACT_VAPORIZATION_","_EXOSPHERE_SOURCE__ON_","models/exosphere/Exosphere.h");
      ChangeValueOfVariable("static const double ImpactVaporization_HeliocentricDistance",$HeliocentricDistance,"models/exosphere/Exosphere.h");
      ChangeValueOfVariable("static const double ImpactVaporization_SourceRatePowerIndex",$SourceRatePowerIndex,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double ImpactVaporization_SourceRate\\[\\]",\@SourceRate,"models/exosphere/Exosphere.h");
      ChangeValueOfArray("static const double ImpactVaporization_SourceTemeprature\\[\\]",\@SourceTemperature,"models/exosphere/Exosphere.h");

      RedefineMacro("_EXOSPHERE_SOURCE__ID__IMPACT_VAPORIZATION_",$SourceProcessID,"models/exosphere/Exosphere.h");
...
RedefineMacro("_EXOSPHERE__SOURCE_TOTAL_NUMBER_",$TotalNumberOfExosphericSources,"models/exosphere/Exosphere.h");
RedefineMacro("_EXOSPHERE__SOURCE_MAX_ID_VALUE_",$MaxSourceIdNumber,"models/exosphere/Exosphere.h");
ChangeValueOfArray("static const char _EXOSPHERE__SOURCE_SYMBOLIC_ID_[][100]",\@SourceProcessesSymbolicID,"models/exosphere/Exosphere.h");
