...
*/
    ...
    if      (BrRatio<.761) {speed=sqrt(((2*k*Te.Interpolate(x))+KineticEnergy1)/((massC*massO+massC*massC)/(2*massO)));}
    else if (BrRatio<.906) {speed=sqrt(((2*k*Te.Interpolate(x))+KineticEnergy2)/((massC*massO+massC*massC)/(2*massO)));}
    else                   {speed=sqrt(((2*k*Te.Interpolate(x))+KineticEnergy3)/((massC*massO+massC*massC)/(2*massO)));}
