...
#define _PIC__USER_DEFINED__USER_PHYSICAL_MODEL_LIST_ "Europa.h"
...
#define _PIC_PARTICLE_MOVER__TOTAL_PARTICLE_ACCELERATION_(acclMiddle,spec,ptr,xMiddle,vMiddle,middleNode) \
    Europa::TotalParticleAcceleration(acclMiddle,spec,ptr,xMiddle,vMiddle,middleNode);


//Include Europa model's header
...
#define _PIC_USER_DEFING_PARTICLE_SAMPLING_(tempParticleData,LocalParticleWeight,tempSamplingBuffer,s) \
    Europa::Sampling::SampleParticleData(tempParticleData,LocalParticleWeight,tempSamplingBuffer,s);
...
#define _PIC__USER_DEFINED__MPI_MODEL_DATA_EXCHANGE_() \
    Europa::ExchangeSurfaceAreaDensity();
...
#define _PIC__USER_DEFINED__CLEAN_SAMPLING_DATA_() \
    Europa::Sampling::FlushSamplingDataBuffers();
