...
void Exosphere::ExchangeSurfaceAreaDensity() {
  ...
  memcpy(TotalFlux_LOCAL,Sphere->SodiumSurfaceElementAdsorptionFluxDOWN,PIC::BC::InternalBoundary::Sphere::TotalSurfaceElementNumber*sizeof(double));
  memcpy(TotalFlux_GLOBAL,Sphere->SodiumSurfaceElementDesorptionFluxUP,PIC::BC::InternalBoundary::Sphere::TotalSurfaceElementNumber*sizeof(double));
...
//====================  END DEBIG =====================
      ...
      Sphere->SodiumSurfaceElementPopulation[el]+=TotalFlux_GLOBAL[el];
      ...
      Sphere->SodiumSurfaceElementPopulation[el]=SurfaceElementArea[el]*(_EXOSPHERE__SURFACE_CONTENT_DENSITY__USER_DEFINED__FUNCTION_(el));
#endif
      ...
      t=Exosphere::SourceProcesses::PhotonStimulatedDesorption::GetSurfaceElementProductionRate(_NA_SPEC_,el,Sphere);
      ...
      t=Exosphere::SourceProcesses::ThermalDesorption::GetSurfaceElementProductionRate(_NA_SPEC_,el,Sphere);
      ...
      t=Exosphere::SourceProcesses::SolarWindSputtering::GetSurfaceElementProductionRate(_NA_SPEC_,el,Sphere);
    ...
    Exosphere::SourceProcesses::PhotonStimulatedDesorption::SourceRate=TotalPhotonStimulatedDesorptionFlux;
    Exosphere::SourceProcesses::PhotonStimulatedDesorption::maxLocalSourceRate=localMaxPhotonStimulatedDesorptionFlux;

#if _EXOSPHERE_SOURCE__THERMAL_DESORPTION_ == _EXOSPHERE_SOURCE__ON_
    Exosphere::SourceProcesses::ThermalDesorption::SourceRate=TotalThermalDesorptionFlux;
    Exosphere::SourceProcesses::ThermalDesorption::maxLocalSourceRate=localMaxThermalDesorptionFlux;
#endif

#if _EXOSPHERE_SOURCE__SOLAR_WIND_SPUTTERING_ == _EXOSPHERE_SOURCE__ON_
    Exosphere::SourceProcesses::SolarWindSputtering::SourceRate=TotalSolarWindSputteringFlux;
    Exosphere::SourceProcesses::SolarWindSputtering::maxLocalSourceRate=localMaxSolarWindSputteringFlux;
#endif
    ...
    memcpy(Sphere->SodiumSurfaceElementDesorptionFluxUP,TotalFlux_LOCAL,PIC::BC::InternalBoundary::Sphere::TotalSurfaceElementNumber*sizeof(double));
    memcpy(Sphere->SodiumSurfaceElementAdsorptionFluxDOWN,TotalFlux_LOCAL,PIC::BC::InternalBoundary::Sphere::TotalSurfaceElementNumber*sizeof(double));
}
