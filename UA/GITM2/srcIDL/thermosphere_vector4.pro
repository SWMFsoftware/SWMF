...
pro thermosphere_vector4_event,event
                        ...
                        if n gt 1 then begin
                            for i = 0,n-1 do begin
                                ...
                                read_thermosphere_file, mulfiles(i), nvars, nalts,$
                                  nlats, nlons,vars,data,rb,cb,bl_cnt
...
Xmanager,'thermosphere_vector4',mainbase
ptr_free,ptr
end
