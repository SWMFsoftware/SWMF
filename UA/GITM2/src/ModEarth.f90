...
module ModPlanet
 ...
 real, parameter, dimension(5, 5) :: Diff0 = 1.0e4 * reshape( (/ &
       ! 0      02     N2      N     NO
       !---------------------------------+
       0.00,   0.260,  0.260,  0.300,  0.181/8,&            ! O
       0.26,   0.000,  0.181,  0.220,  0.181/8,&            ! O2
       0.26,   0.181,  0.000,  0.220,  0.181/8,&            ! N2
       0.30,   0.220,  0.220,  0.000,  0.181/8, &
       0.181/8,0.181/8,0.181/8,0.181/8,0.00 /), (/5,5/) )  ! N
