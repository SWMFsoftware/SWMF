...
void communicateNode_P(int nx, int ny, int nz, int n4, int n5, double***** vector, const VirtualTopology3D * vct, EMfields3D *EMf);
...
void communicateCenter_P(int nx, int ny, int nz, int n4, double ****vector_CI, const VirtualTopology3D * vct, EMfields3D *EMf);

void communicateSwapAddGhostCell(int nx, int ny, int nz, double*** vector_C, const VirtualTopology3D * vct, EMfields3D *EMf);

void communicateSwapAddGhostCell(int nx, int ny, int nz, int n4, double**** vector_CI, const VirtualTopology3D * vct, EMfields3D *EMf);
...
void communicateInterp(int nx, int ny, int nz, int n4, int n5, double***** vector, const VirtualTopology3D * vct, EMfields3D *EMf);

void addBoundary(int nx, int ny, int nz, int n4, double ****vector, const VirtualTopology3D * vct, bool doSwapGhostCell);
