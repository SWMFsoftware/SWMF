program unit_test_coulomb_collision
  use ModParticle, ONLY: test_coulomb_collision
  use ModMPI
...
!  character(len=7) :: NamePlanet = 'JUPITER'
  ...
  write(*,*) 'starting test_coulomb_collision'

  call timing_active(.true.)
  call timing_step(0)
  call timing_start('unit_test_coulomb_collision')
  
  call timing_start('test_coulomb_collision')
  call test_coulomb_collision
  call timing_stop('test_coulomb_collision')

  call timing_report
end program unit_test_coulomb_collision
