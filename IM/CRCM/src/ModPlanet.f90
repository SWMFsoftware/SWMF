Module ModCrcmPlanet
  ...
  real, dimension(nspec) :: dFactor_I =(/0.80,0.20,1.0/)
  ...
  integer, dimension(nspec+1) :: iPparhotplot_I =(/9,10,11,12/)
  integer, dimension(nspec+1) :: iNplot_I    =(/13,14,15,16/)
  integer, parameter          :: Beq_=17,Vol_=18,Pot_=19, FAC_=20, nVar=20
