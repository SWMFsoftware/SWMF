...
! Distribution Notice:
!
!  This information has not been approved for public release. Further 
!  dissemination must be approved by the Commanding Officer, NRL or any other
!  controlling agency.
!
! =======================================================================
...
subroutine apxrda()
    ...
    open(unit=77,file='apexgrid.inp',form='unformatted')
