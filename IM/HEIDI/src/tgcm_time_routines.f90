!^CFG COPYRIGHT UM
subroutine tgcm_time_int_to_real(itime, timereal)
...
end subroutine tgcm_time_int_to_real



subroutine tgcm_time_real_to_int(timereal, itime)
...
end subroutine tgcm_time_real_to_int


function tgcm_jday(year, mon, day) result(Julian_Day)
