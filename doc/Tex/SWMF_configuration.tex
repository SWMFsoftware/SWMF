...
\end{verbatim}
To set the size of the longitude-latitude grid for the IE model, for example, 
\begin{verbatim}
  Config.pl -o=IE:g=181,361
\end{verbatim}
will set the ``theta-phi'' grid size to $181\times 361$ for both hemispheres,
so it is half degree resolution in colatitude and one degree in longitude.
This command runs the {\tt Config.pl} script of the selected IE component. 
