...
developed at the University of Michigan.  This code solves the
multifluid equations along multiple field lines and it is fully parallel.

\item
There are two versions for the Radiation Belt (RB) component: 
the Rice Rardiation Belt Model (RRBM) is developed at Rice University,
the Radiation Belt Environment (RBE) model is developed at Goddard.
Both codes are 2-dimensional and serial.
...
models developed at CSEM by Ridley, Deng, and Toth.  They are fully parallel.
