...
function form1() {   //
  ...
  echo "
<b>Satelite File:</b> ($countfiles files found)<br>
<div class=\"indent\">
  ";
...
function plot4() {   // Download for self-plot instructions
  ...
  Exec("cd $batchdir/$tmpdir;
        ...
        echo '<A HREF=\"${imagedir}/styleXY.sty\">styleXY.sty</A><br>' >> page.html;
        echo '<A HREF=\"${imagedir}/styleXZ.sty\">styleXZ.sty</A><br>' >> page.html;
